...
void main() {
  group('Results and History Tests', () {
    testWidgets('should display game results correctly', (WidgetTester tester) async {
      ...
      gameProvider.addStandardBall(playerId1, points: 50); // Player 1 gets 50 points
      gameProvider.addStandardBall(playerId2, points: 30); // Player 2 gets 30 points
      ...
      expect(find.text('Frames Won: 0'), findsNWidgets(2)); // Both players should have 0 frames won
      expect(find.text('Highest Break: 50'), findsOneWidget); // Player 1 should have 50 as highest break
    });

    testWidgets('should display game history correctly', (WidgetTester tester) async {
      final gameProvider = GameProvider();
      gameProvider.startNewGame(['Player 1', 'Player 2']);
      ...
      expect(find.text('Game on'), findsNWidgets(2)); // Two games should be in history
      expect(find.text('Players: Player 1, Player 2'), findsOneWidget);
      expect(find.text('Players: Player 3, Player 4'), findsOneWidget);
    });

    testWidgets('should navigate to results from history', (WidgetTester tester) async {
      final gameProvider = GameProvider();
      gameProvider.startNewGame(['Player 1', 'Player 2']);
